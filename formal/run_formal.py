"""Run the SymbiYosys jobs for the T0 RTL and write a deterministic summary.
...
JOBS = [
    {"file": "secded.sby", "title": "SECDED: any data word, any single fault corrected, any double fault detected"},
    {"file": "channel.sby", "title": "Channel safety: liveness, refresh priority, response scoreboard (k-induction proof, cover)"},
    {"file": "channel_protocol.sby", "title": "Channel protocol: ECC status valid with rsp_valid"},
]
